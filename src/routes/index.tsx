...
function App() {
  return <div className="App">
    ...
    <div style={{ marginTop: '2rem', maxWidth: '800px', marginLeft: 'auto', marginRight: 'auto', textAlign: 'center' }}>
      <img src="/home-diagram.png" alt="Home Diagram" style={{ width: '100%', height: 'auto', display: 'block', marginLeft: 'auto', marginRight: 'auto' }} />
    </div>
  </div>
}
